"""bikedoctor_29424 URL Configuration
...
admin.site.site_header = "BikeDoctor"
admin.site.site_title = "BikeDoctor Admin Portal"
admin.site.index_title = "BikeDoctor Admin"

# swagger
api_info = openapi.Info(
    title="BikeDoctor API",
    default_version="v1",
    description="API documentation for BikeDoctor App",
)
